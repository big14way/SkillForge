-- SkillForge indexer schema (SQLite / better-sqlite3).
-- All big numbers (price, amount, earnings) are stored as TEXT to preserve
-- bigint precision — callers parse back with BigInt().
